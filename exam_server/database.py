...
# __file__ -> .../Shop_Exam/exam_server/database.py
# os.path.dirname(__file__) -> .../Shop_Exam/exam_server
# os.path.dirname(...) -> .../Shop_Exam
PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
DATABASE_PATH = os.path.join(PROJECT_ROOT, 'shop.db')

# Используем абсолютный путь для подключения
